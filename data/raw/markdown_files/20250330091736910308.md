...
Process
in Scanner
(1) Decision made that patient in distress and needs to be moved from scanner for care

Make decision to call a code

Call Code Team by dialing 155

Stand by door to MRI suite to allow access for Code Team

Prepare to move patient out of scanner

Disconnect wall 02 source

It was determined that it is a safety risk to try to
beep the oxygen attached to the flow meter while moving patient. Self-inflating bags will function without oxygen source and can be reconnected once in recovery bay.

The patient may or may not be
The patient may or may not be
coding but needs to be
removed from scanner for
appropriate assessment and
management.
This decision will be made by
MD provider. Provider should
call out clearly and ask Tech to
Call the code team using closed
loop communication.
Tech will call the code team
and announce campus and
location
The door to MRI suite can only
be accessed by MRI staff. An
individual must stand by the
door to the suite to allow Code
Team to access
Prepare patient to be moved
forther by disconnecting monitoring
lines and pumps.

MD (Anesthesia or Sedation)
...
Technologist/ MR Nurse (1) stretcher
...
| $\square$ Move MRI Table from Scanner to Recovery |
| Bay with other staff |
...
|  |  |  | $\begin{aligned} & \text { REF 10- } \\ & 1400 \mathrm{M} \end{aligned}$ | $\begin{aligned} & \text { SpF®- } \\ & \text { PLUS- } \\ & \text { L } 2 / \mathrm{DM} \end{aligned}$ | MESH |  |  |  |  |  |
...
| $\begin{aligned} & \hline \text { (40μA } \\ & \text { ) } \end{aligned}$ \#0153 |  | $\begin{aligned} & \text { REF 10- } \\ & \text { 1396W } \end{aligned}$ | $\begin{aligned} & \text { SpF® } \\ & \text { XL } \\ & \text { 4/CW } \end{aligned}$ | WAVE | N/A | N/A | N/A | N/A |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| SpF <br> XL IIb <br> (40 $\mu$ A ) | OBSOLE <br> TE | $\begin{aligned} & \text { REF 10- } \\ & \text { 1385M } \end{aligned}$ | $\begin{aligned} & \text { SpF® } \\ & \text { XL IIb } \\ & \text { 2/DM } \end{aligned}$ | MESH | 1.5 <br> Tesla or Less. | 450 | $\begin{aligned} & \text { 1.1 W/kg } \\ & \text { for } 25 \\ & \text { Minutes } \\ & \text { of } \\ & \text { Imaging. } \end{aligned}$ | 20 <br> Tesla/Seco nd or Less. | Table 3 |  |
...
| SpF <br> XL II <br> (40 $\mu$ A ) | OBSOLE <br> TE | $\begin{aligned} & \text { REF 10- } \\ & \text { 1375W } \end{aligned}$ | $\begin{aligned} & \text { SpF® } \\ & \text { XL II } \\ & \text { 2/DW } \end{aligned}$ | WAVE | N/A | N/A | N/A | N/A |  |
| $\begin{aligned} & \text { EBI® } \\ & \text { SpF® } \\ & \text { PLUS } \\ & \text { (60μA } \\ & \text { ) \#05 } \end{aligned}$ | OBSOLE <br> TE | $\begin{aligned} & \text { REF 10- } \\ & \text { 1389M } \end{aligned}$ | $\begin{aligned} & \text { SpF® } \\ & \text { PLUS } \\ & \text { 2/DM } \end{aligned}$ | MESH | N/A | N/A | N/A | N/A |  |
...
| $\begin{aligned} & \text { EBI® } \\ & \text { SpF® } \\ & \text { XL } \\ & \text { (40μA } \\ & \text { ) } \end{aligned}$ | OBSOLE <br> TE | $\begin{aligned} & \text { REF 10- } \\ & \text { 1370WI } \end{aligned}$ | $\begin{aligned} & \text { SpF® } \\ & \text { XL } \\ & \text { 4/CW } \end{aligned}$ | WAVE | N/A | N/A | N/A | N/A |  |
...
![img-21.jpeg](img-21.jpeg.png)

---

# Medtronic Reveal Linq -Loop Recorder 

![img-22.jpeg](img-22.jpeg.png)
...
![img-23.jpeg](img-23.jpeg.png)

ST. JUDE MEDICAL SJM CONFIRM
![img-24.jpeg](img-24.jpeg.png)
![img-25.jpeg](img-25.jpeg.png)
...
![img-31.jpeg](img-31.jpeg.png)

MRI posts have a GOLD tip.
![img-32.jpeg](img-32.jpeg.png)

These Straight and Curved Rods are designed for MRI use. They are color coded in YELLOW.
![img-33.jpeg](img-33.jpeg.png)

The Hoffmann ${ }^{\circledR}$ II MRI System can only be guaranteed for MRI use when using Stryker's Apex ${ }^{\circledR}$ Pins to build a frame.

The Hoffmann ${ }^{\circledR}$ II MRI System is designed for MRI use up to 3.0 Tesla. To ensure patient safety during MRI procedures and to distinguish the system from the standard Non-MRI Hoffmann ${ }^{\circledR}$ II System, the Hoffmann ${ }^{\circledR}$ II MRI is color-coded in GREEN.

Standard Hoffmann ${ }^{\circledR}$ II (Non MRI Safe)
These products are ferromagnetic and/or conductive; therefore, they are not MRI Safe.
![img-34.jpeg](img-34.jpeg.png)

4920-2-080
![img-35.jpeg](img-35.jpeg.png)

These standard rods come in aluminium, carbon and stainless steel. Do not mix them with the MRI System since they are not MRI Safe.
![img-36.jpeg](img-36.jpeg.png)

4920-0-000
![img-37.jpeg](img-37.jpeg.png)
...
![img-40.jpeg](img-40.jpeg.png)

The MRI components have been tested according to ASTM Standards F2052, F2182, and F2213.

The color coding scheme illustrated below must be followed to ensure correct MRI usage.
![img-41.jpeg](img-41.jpeg.png)

MRI posts have a GOLD tip.
![img-42.jpeg](img-42.jpeg.png)

MRI rods are YELLOW.
![img-43.jpeg](img-43.jpeg.png)
...
![img-46.jpeg](img-46.jpeg.png)
3.0 Tesla MR System
$\nabla \theta_{\text {max }}: 70 \mathrm{~m} / 1 / \mathrm{cm}$
$\Delta \mathrm{T}_{\text {max }}: 1.55^{\circ} \mathrm{C}$ at $0.5 \mathrm{~W} / \mathrm{kg}$ at a whole body average SAR for MR imaging time of 6 minutes
![img-47.jpeg](img-47.jpeg.png)
...
$\nabla \mathrm{R}_{\max }: \quad 70 \mathrm{~m} / 1 / \mathrm{cm}$
$\Delta \mathrm{T}_{\max }: \quad 1.96^{\circ} \mathrm{C}$ at $0.5 \mathrm{~W} / \mathrm{kg}$ at a whole body average SAR for MR imaging time of 6 minutes
